...
do
    function Library.new(info)
        ...
        local function makeLoader()
            ...
            Converted["_Message1"].Text = sigmasibiditoiletskibiditosigmamimgiemgmgeg
        ...
        if info.UseLoader then
            ...
            table.insert(_connections,utility:HandleGradientButton(main.Yes,function()
                ...
                if nextKey then
                    ...
                    text.Text = sigmasibiditoiletskibiditosigmamimgiemgmgeg2
                    table.insert(_connections,utility:HandleGradientButton(btn,function()
                        if text.Text == sigmasibiditoiletskibiditosigmamimgiemgmgeg2 then
                            text.Text = "Copied"
